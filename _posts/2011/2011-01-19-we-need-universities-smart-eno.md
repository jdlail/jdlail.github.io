---
layout: post
permalink: /2011/01/we-need-universities-smart-eno/
title: We need universities smart enough to fix the potholes
description: None
date: 2011-01-19 22:22:35 -0000
last_modified_at: 2011-01-19 22:22:35 -0000
publish: true
pin: false
categories:
- Carnival
...
First, thanks to [Dave Cohn](https://blog.digidave.org/) for reviving the [Carnival of Journalism](https://carnivalofjournalism.com/). We haven't put up the big tent in a long while.  
  
For this [carnival](https://natureblognetwork.com/blog/what-is-a-blog-carnival/), a number of journalism bloggers have been asked by Cohn to write about one topic: The changing role of Universities for the information needs of a community: [One of the Knight Commission's recommendations](https://www.knightcomm.org/recommendation3/) is to "Increase the role of higher education ... as hubs of journalistic activity."  
  
![Knight Commission](/images/knight3.webp)You can find links to [all of the pieces here](https://carnivalofjournalism.com/) in a couple days.  
...
Tech experts, for example, could create a tool to visually show potholes, maybe using an application like the [Ushahidi Platform](https://ushahidi.com/)  
...
Early in the days of the public Internet, a group at the University of Tennessee led by [Greg Cole](https://isse.utk.edu/staff/cole.html) created the idea of a [freenet](https://en.wikipedia.org/wiki/Freenet)-type or community portal service for the Knoxville, Tennessee, region. In large part due to Cole's infectious enthusiasm for the project,  KORRnet, short for Knoxville-Oak Ridge Regional Network, launched in March 1994. It's called [DiscoverET.org](https://www.discoveret.org/index.php?p=AboutUs) today.  
