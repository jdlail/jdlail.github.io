...
[![](https://seesmic.com/images/spacer.gif)](https://seesmic.com/)  
He notes the Twitter user had _better information_ than the official news sources. The Associated Press apparently agreed, also [picking up on the messages](https://hosted.ap.org/dynamic/stories/A/AIRPORT_ACCIDENT?SITE=TNKNN&SECTION=HOME&TEMPLATE=DEFAULT) from the Twitter user on the plane in its wire reports:  
...
Here's passenger Mike Wilson's [Twitter page](https://twitter.com/2drinksbehind).  
