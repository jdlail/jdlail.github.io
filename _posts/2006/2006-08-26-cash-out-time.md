...
The article recounts the by now familiar (and highly successful) move by Scripps into cable networks. But it then turns to:
...
It's shaping up as an interesting next few years for us in the "paper" biz. I think newspapers will make the transition, but will be bloodied and bruised getting there. I certainly agree with writer Diane Mermigas that:
