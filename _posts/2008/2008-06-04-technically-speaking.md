---
layout: post
permalink: /2008/06/technically-speaking/
title: Technically speaking ...
date: 2008-06-04 06:37:32 -0000
last_modified_at: 2008-06-04 06:37:32 -0000
publish: true
pin: false
categories:
- Ramblings
...
I only ran into one glitch. I couldn't see my blog preferences menu (which is bad). I turned in a bug report and decided to sleep on it. This morning I went into MT's [beta forums](https://forums.movabletype.org/) and  got the answer in four minutes! User [dug](https://www.movabletype.org/cgi-bin/athena/mt-cp.fcgi?__mode=view&id=1426) said disabling the iPhone/iTouch interface plug in fixed that for me. It did for me, too! Hopefully, that plugin will be upgraded.  
  
A number of new things and performance improvements are in version 4.2 RC1, if you [are interested](https://beta.movabletype.org/documentation/mt42/whats-new.html).
