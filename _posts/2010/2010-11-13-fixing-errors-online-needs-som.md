...
The concept of "paper of record' has already moved from print to online, just look for all the articles on the Web about "[reputation management](https://www.google.com/#sclient=psy&hl=en&q=%22reputation+management%22&aq=f&aqi=g4g-o1&aql=&oq=&gs_rfai=&pbx=1&fp=8e8b714760cd89d8)" (it's a mini-industry). When someone is looking for information on a person or a place, or a thing or an event, they are going to Google; not heading to the public library for an exciting date with microfilm.  
...
(And every news organization is dealing with an increasing number of "unpublish requests," a topic that an APME Online Credibility project headed by Kathy English of the Toronto Star [dealt with](https://www.apme.com/events/event_details.asp?id=112519) extensively earlier this year with a [Poynter NewsU webinar](https://www.newsu.org/unpublishing-online-content-credibility) and a [downloadable report](https://www.apme.com/?page=Unpublishing) that includes a framework for developing a policy.)  
  
While the academic study Silverman refers to above is from a couple years ago, a [new survey of online correction practices](https://mediabugs.org/pages/the-wrong-stuff)has just come out. [MediaBugs](https://mediabugs.org/), a website and project headed by [Scott Rosenberg](https://en.wikipedia.org/wiki/Scott_Rosenberg_%28journalist%29 "Scott Rosenberg \(journalist\)") and Mark Follman, published earlier this week the results of a survey that highlights the haphazard approach by major news organizations in dealing with corrections online.  
  
[One finding](https://mediabugs.org/blog/2010/11/09/survey-news-websites-across-us-botch-error-reporting-corrections/) ought to particularly rankle those in newspapers, whose editors often puff their chests with pride as they say newspapers are much more credible sources of information than other media, particularly TV news and blogs:  
...
(Image from [PopHangOver](https://pophangover.com/2010/03/23/the-funniest-newspaper-corrections-ever/).)  
  
###### Related articles

* [MediaBugs: How US newspapers differ on corrections and clarifications](https://blogs.journalism.co.uk/editors/2010/11/10/mediabugs-how-us-newspapers-differ-on-corrections-and-clarifications/) (blogs.journalism.co.uk)
* [They Regress the Error](https://www.boingboing.net/2010/10/29/they-regress-the-err.html) (boingboing.net)
* [Craig Silverman shares excellent advice on accuracy, verification and preventing errors](https://stevebuttry.wordpress.com/2010/10/29/craig-silverman-shares-excellent-advice-on-accuracy-verification-and-preventing-errors/) (stevebuttry.wordpress.com)
