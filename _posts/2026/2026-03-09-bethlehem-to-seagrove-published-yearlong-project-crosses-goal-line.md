---
layout: post
title: "Bethlehem ... to Seagrove published: Yearlong project crosses goal line"
date: 2026-03-09 17:23:59 -0400
categories: [Family]
...
It is available in [paperback and Kindle](https://a.co/d/00MbNdlY) versions.
...
Sandra pulled me into the project to edit the audio of the raw recordings (which we have [made available](https://bethlehemtoseagrove.com/audio/) as a complement to the book), and to help with prepping, formatting and processing the manuscript for Amazon's publishing platform.

## Creating the book

It is the first book either of us had published on Amazon so there was a lot of learning along the way.

The task of creating the book was made easier using a credt card sized recorder called [Plaud Note](https://www.plaud.ai/products/plaud-note-ai-voice-recorder), which not only records the audio, but uses artificial intelligence to transcribe the audio.

AI was only used as an aid. The book is my Dad's recollections, thoughts and words and is not AI generated.

The manuscript was created in Microsoft Word and formatted and finished in Amazon's free [Kindle Create](https://kdp.amazon.com/en_US/help/topic/GUGQ4WDZ92F733GC) software before being uploaded onto Kindle Digital Publishing, or [KDP](https://kdp.amazon.com).

The paperback and Kindle book covers were created in [Canva](https://canva.com).

The cover illustration is a photo of a painting Mom did of the farmhouse where my Dad grew up.

One of my tasks was to create a simple website for the book. I put [bethlehemtoseagrove.com](https://bethlehemtoseagrove.com) up on GitHub pages.
