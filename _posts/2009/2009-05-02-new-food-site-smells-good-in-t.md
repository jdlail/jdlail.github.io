...
Looks like Scripps Networks has a winner. It's obvious a great URL for a food site and if they can make the search engine work, it should attract foodies by the grocery bag. There are some other players, TechCrunch commenters liked [RecipeBridge.com](https://www.recipebridge.com/) and [SuperCook.com](https://www.supercook.com/), but one would think that between the domain name and FoodNetwork/HGTV's promotional power on TV and on the Web, the site would have to really stink not to be dominate  
...
Scripps Networks seems to be cooking up a lot of innovations in the food space. It also recently launched [Food2.com](https://www.food2.com/), sort of social networking meets cooking for [21 to 34 year olds](https://blogs.knoxnews.com/knx/harrington/2009/04/scripps_networks_launches_new.html). Hey, doesn't everybody gather to gab in the kitchen?  
