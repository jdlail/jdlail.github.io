...
I was replacing an ASUS dual-band [AiMesh network](https://techcyn.com/editorials/asus-aimesh-what-is-aimesh-why-aimesh-is-unique-compared-to-other-whole-home-mesh-wifi-solution/) consisting of a router and a single node so upgrading to a newer, fancier model of the same well-known brand was the route I took; buying a pair of Asus ZenWiFi XT8s, a [highly rated Wi-Fi 6 tri-band mesh network](https://dongknows.com/asus-zenwifi-ax-xt8-review/).

(A [mesh network](https://www.tomsguide.com/us/what-is-mesh-wifi-router,news-24580.html) explained.)

Such a change, I have learned, is not for the faint of heart.

It would arguably have been easier to use the [same network name and password](https://www.reviewgeek.com/66190/new-router-simplify-network-setup-by-reusing-your-ssid-and-password/), but I didn’t. I had different names (or SSIDs) for the 2.4 and 5 ghz networks and I only wanted to use one SSID and pasword and let the devices choose which band to use. My old password wasn’t the safest, either, and these are perilous times.
...
The most difficult to update turned out to be “Internet of Things,” or [IoT](https://www.zdnet.com/article/what-is-the-internet-of-things-everything-you-need-to-know-about-the-iot-right-now/) smart devices; thermostats, smoke detectors, smart plugs, security cameras. Some can be updated via their smartphone apps, others have to be reset to factory settings and set up again. It varies by manufacturer. [Boy, do we need a standard there](https://www.digitaltrends.com/home/swapping-smart-home-devices-between-wi-fi-annoying/).
...
There’s also [a bit more than a little love-hate relationship with ZenWiFi XT8](https://www.snbforums.com/forums/asus-ax-routers-adapters.56/). Some say it works great; some never get it to work to their liking. I’ve seen excellent coverage and great speeds out of it and it works great except for a few devices.

The bleeding edge [Wi-Fi 6](https://www.popsci.com/reviews/what-is-wifi-6/) mesh networking systems often [have issues with older devices and “smart home” devices](https://www.digitaltrends.com/home/swapping-smart-home-devices-between-wi-fi-annoying/). This certainly has been the case for me. My Nest thermostats and Protects often show offline in the Nest app now, but never did on my old network.
