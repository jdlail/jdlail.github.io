...
pin: false
image:
  path: /assets/wp-content/uploads/2023/07/DSCF3710-scaled.webp
  alt: Tesla Model Y
categories:
- Tesla
tags:
...
So far, Tesla has done an outstanding job of expanding and building out [its network of chargers](https://www.tesla.com/supercharger).
...
I recently sprang for Level 2 charger as well at that mountain house that plugs into a NEMA 14-50 outlet (modern dryer outlet) ona 50-amp circuit. The [Grizzl-E Classic](https://grizzl-e.com/home-products/) from United Chargers can add about 40 miles an hour. It's a huge convenience factor since once you're off the interstate system and away from cities, fast charging options are still scarce.
...
The EPA estimated the 2020 MY Long Range model to have 127 [MPGe](https://www.caranddriver.com/research/a31863350/mpge/) (miles per gallon of gasoline-equivalent) in the city and 114 MPGe on the highway.
...
(There are lot of [Tesla checklists](https://blog.tesbros.com/tesla-delivery-checklist/) out there.)
...
The official range of my car new was 316 miles. A few months later, in October, the official [range was increased to 325 miles](https://electrek.co/2020/10/16/tesla-software-update-increasing-range-existing-vehicles/) via software tweaks.
...
(Here's a handy [calculator to convert Watt-hour](https://www.aqua-calc.com/convert/electric-car-energy-economy/watt-hour-per-mile-to-mile-per-kilowatt-hour)[s](https://www.aqua-calc.com/convert/electric-car-energy-economy/watt-hour-per-mile-to-mile-per-kilowatt-hour)[per mile to miles per kilowatt-hour](https://www.aqua-calc.com/convert/electric-car-energy-economy/watt-hour-per-mile-to-mile-per-kilowatt-hour).)
...
I do use the website/app [A Better Route Planner](https://abetterrouteplanner.com/) to plan trips in advance. The car and ABRP often have different plans on where and when to stop to charge.
...
My MY came with a mobile charger and 120 plug adapter. I bought a NEMA 14-50 adapter (fits modern dryer outlets), but it's never been used. I do use the [SAE J1772](https://zevsociety.com/the-sae-j1772-ev-charger-guide/) adapter that came with the car.

## Full Self Driving

"Full Self Driving" was $8,000 when I bought my car. It is $15,000 in the summer of 2023. I am on the [Full Self Driving beta](https://www.tesla.com/ownersmanual/modely/en_us/GUID-2CB60804-9CEA-4F4B-8B04-09B991368DC5.html) software.

I think it works really well on interstate highways and reduces fatigue on long drives. You still need to be always ready to intervene. It doesn't take much rain to "degrade" it.

![Tesla Full Self Driving](/assets/wp-content/uploads/2023/07/GUID-42A7BAF7-B96B-4889-A999-7A19C4A8317D-online-en-US.webp)

On city streets and East Tennessee curvy back roads, I don't use it often. While it seems to turn late into curves, my biggest concern is it will do something unexpected and I will get rearended. It does sometimes stop to think about what to do.
...
Except for the "[amnesty](https://insideevs.com/news/678141/tesla-announces-full-terms-fsd-beta-one-time-transfer/)" option during this quarter, Tesla does not you transfer FSD to a different vehicle. And it can't always be transferred with the car on a trade-in. You can transfer FSD in private party sales, but probably not in a trade-in to a dealership. And people have been unhappy with the value Tesla is assigning it in trade-ins.
...
I get more software updates on my Tesla than I do on my phone. I have had 62 software updates, an average of one every 17 days, according to stats from[TeslaFi](https://teslafi.com/).

## Tires

[EVs use up tires](https://www.pcmag.com/news/the-unexpected-problem-with-evs-they-tire-quickly) faster than gas cars due to quick acceleration and vehicle weight. The OEM Continental ProContact RX tires on my MY lasted 27,367 miles. Compared to the experience of others I've seen that is pretty good.

I averaged 260 Wh/mile with those tires.

I replaced them with a set of Vredestein Quatrac Pro tires, not an EV specific tire, but rated XL and [a tire that has its fans among EV owners](https://teslamotorsclub.com/tmc/threads/2021-model-y-tire-options-for-better-ride-range.224850/). They are alot cheaper, too.
...
There is a lot of great information about Teslas available: YouTube channels, Reddit groups, local and regional Facebook groups and the [Tesla Motors Club](https://teslamotorsclub.com/tmc/feeds/), Subscribe, follow, join all of them.

I find these websites, apps, services really useful:

\- [TeslaFi](https://teslafi.com/userlogin.php). Pulls data from your car and gives you a rich data history about trips, battery life and charging among other things.

\- [A Better Route Planner](https://abetterrouteplanner.com/). Great tool to plan trips. It can also be set to pull real time data fromt eh car for greater accuracy.

\- [Plugshare](https://www.plugshare.com/). An app that is a directory of charging location with photos, descriptions and user reviews.

Others that might be useful:

\- There is a [Tesla Voice Command](https://teslavoice.glideapp.io/dl/da19fa) app but I'm not sure if it's still being updated.
