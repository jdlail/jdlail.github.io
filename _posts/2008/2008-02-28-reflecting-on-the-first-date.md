...
Rich Gordon, a New Media journalism professor at Northwestern, called it a first date and has a [great rundown](https://www.pbs.org/idealab/2008/02/journalists-and-technologists.html) on some of the key points brought up by speakers.  
...
He also points to another great recap of the sessions that I hadn't seen: John Christopher Burns' coverage [here](https://positivelyatlantaga.com/2008/02/24/making-journalism-compute/) and [here](https://positivelyatlantaga.com/2008/02/25/sensemaking-and-nonsensibility), who was using one of those "One Laptop Per Child" ([OLPC](https://laptop.org/)) computers at the two-day event.  
