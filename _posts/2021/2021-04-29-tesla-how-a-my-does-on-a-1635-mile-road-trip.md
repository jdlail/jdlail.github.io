...
pin: false
image:
  path: /assets/wp-content/uploads/2021/04/route.webp
categories:
- Ramblings
- Tesla
tags:
...
(All data from [Teslafi.com](https://teslafi.com).)

I used the popular [A Better Route Planner](https://abetterrouteplanner.com/) to map out my trip, A Better Route Planner differs from Tesla's built-in navigation by trying to optimize charging time with shorter charges, but more frequent stops.
...
{% include youtube.html id="Pz4OoKnYwTI" %}
...
Next was the return stop to the Lexington supercharger, where I charged from 16% to 69% in 20 minutes.

![](/assets/wp-content/uploads/2021/04/tesla-charging2.webp)Tesla charging in Lexington, Va., at Holiday Inn Express

The return Wytheville stop was 11 minutes with 34% added to the battery (18% to 52%).

Next was the return to the Bristol supercharger, where I sat for 15 minutes charging from 21% to 53%.

![](/assets/wp-content/uploads/2021/04/bristol-supercharging.webp)Tesla supercharge in Bristol at The Pinnacle

As you can, I never cut it close getting to a supercharger, with the lowest state of charge at arrival at 13%. Obviously, I could have reduced my charging time by a few minutes at several stops.

I tried to drive 72-73 in the 70 mile per hour zone, but my average speed was lower due to an abundance of road construction and congestion around the larger cities.

![](/assets/wp-content/uploads/2021/04/charging4.webp)

The 282 Wh/mile works about to a range of 256.65 miles based on 72.5 KWh of usable battery (there is a bit of debate about usable battery size, and battery degradation figures in, too).
